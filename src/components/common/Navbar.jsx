...
// ─── Mega Menu Panel ───────────────────────────────────────
function MegaMenuPanel({ data, onClose }) {
  return (
    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-[760px] bg-white border border-slate-200 rounded-xl shadow-lg overflow-hidden animate-slide-down z-50">
              ...
              <div className="relative">
                ...
                {activeMega === 'colleges' && (
                  <div onMouseEnter={() => setActiveMega('colleges')} onMouseLeave={() => setActiveMega(null)}>
                    <MegaMenuPanel data={collegesMegaMenu} onClose={() => setActiveMega(null)} />
                  </div>
                )}
              </div>
              ...
              <div className="relative">
                ...
                {activeMega === 'exams' && (
                  <div onMouseEnter={() => setActiveMega('exams')} onMouseLeave={() => setActiveMega(null)}>
                    <MegaMenuPanel data={examsMegaMenu} onClose={() => setActiveMega(null)} />
                  </div>
                )}
              </div>
