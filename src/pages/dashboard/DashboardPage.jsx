            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                {[
                  ...
                  { label: 'Exam Reminders', value: data?.reminders?.length || 0, icon: Bell, bg: 'bg-amber-50 text-amber-600', hoverBg: 'group-hover:bg-amber-600 group-hover:text-white', href: () => setActive('exams') },
                ].map((card, i) => (
                  <button
                    key={i}
                    onClick={card.href}
